...
public class helloworld {
    public static void main(String[] args) throws Exception {
        ...
        String apiKey = "QNN6ISHRM53OXKDEKPTK2195DJtJDbXahfrBjimmfEV4KPhVk";
        String sharedSecret = "hfaM$xx0TD{qWs6v$PV87ET/iTD-6igdUxt7{DaN";
        String resourcePath = "visasuppliermatchingservice/v1";
        String queryString = "apiKey=" + apiKey;
        String requestBody = "";
        System.out.println("START Sample Code for Api Key-Shared Secret (X-Pay-Token)");
        URL url = new URL("https://sandbox.api.visa.com/visasuppliermatchingservice/v1/search?" + queryString);
